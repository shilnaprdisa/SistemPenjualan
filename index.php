		...
		<div class="container">
			<div class="w3_footer_grids">
				<div class="col-md-4 w3_footer_grid">
					...
					<ul class="address">
						<li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>Jalan Jenderal Soedirman, No.21. Purwokerto</li>
						<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="arionshoes:info@email">arionshoes@email</a></li>
